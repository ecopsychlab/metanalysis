...
- define analyses - see
  [`arrow::register_scalar_function()`](https://arrow.apache.org/docs/r/reference/register_scalar_function.html) -
  looks really nice, but almost certainly would require some nice
  wrapping for our target audience.
